...
export const sdMockExamQuestions = [
  ...
  // Ch1 — Structures organisationnelles SD (+5)
  { id: "exam-41", chapter: "Structures organisationnelles SD", question: "Le canal de distribution (Distribution Channel) en SD permet :", options: ["De gérer les transports", "De segmenter les ventes par mode commercial : retail, wholesale, e-commerce", "De définir le pays", "De configurer la TVA"], correctIndex: 1, explanation: "Le Distribution Channel segmente les ventes par mode commercial. Permet d'avoir des prix et données client différents selon le canal. Combinaison Sales Org + Distribution Channel + Division = Sales Area." },
  { id: "exam-42", chapter: "Structures organisationnelles SD", question: "La Sales Area en SAP SD est :", options: ["Une zone géographique", "La combinaison Sales Organization + Distribution Channel + Division — base de la plupart des configurations SD", "Un groupe de clients", "Un type de transport"], correctIndex: 1, explanation: "Sales Area = Sales Org × Channel × Division. Unité organisationnelle clé de SD. Prix, données client et conditions de vente sont définis par Sales Area pour gérer finement les règles commerciales." },
  { id: "exam-43", chapter: "Structures organisationnelles SD", question: "Le Shipping Point (Point d'Expédition) :", options: ["Est l'adresse du client", "Est l'unité physique d'expédition (entrepôt, quai), assignée à une division. Détermine les délais transport", "Est uniquement utilisé pour les exports", "Est égal au Sales Office"], correctIndex: 1, explanation: "Shipping Point = unité physique d'expédition (entrepôt, quai). Rattaché à une division. Détermination automatique selon division + Loading Group + Shipping Condition." },
  { id: "exam-44", chapter: "Structures organisationnelles SD", question: "Le Sales Office (Bureau commercial) en SAP :", options: ["Est obligatoire", "Est un regroupement géographique optionnel (région commerciale) avec ses Sales Groups (équipes)", "Remplace la Sales Org", "Gère la facturation"], correctIndex: 1, explanation: "Sales Office = bureau régional optionnel. Contient les Sales Groups (équipes commerciales). Affecté aux Sales Areas. Reporting commercial régional." },
  { id: "exam-45", chapter: "Structures organisationnelles SD", question: "Une Loading Group (groupe de chargement) :", options: ["Est un groupe de clients", "Qualifie l'article pour la détermination automatique du shipping point (palette, vrac, liquide)", "Est un type de facture", "Est un transporteur"], correctIndex: 1, explanation: "Loading Group qualifie les conditions de chargement (palettes, vrac, hors gabarit). Avec Shipping Condition + Division, détermine le bon Shipping Point." },
  // Ch2 — Données de base SD (+6)
  { id: "exam-46", chapter: "Données de base SD", question: "Le Customer-Material Info Record (CMIR) :", options: ["Est obsolète", "Stocke les correspondances client-matériau : numéro article client, prix spécifiques, conditions livraison", "Est créé automatiquement", "Remplace la fiche article"], correctIndex: 1, explanation: "CMIR (VD51) : permet au client d'utiliser sa propre référence article sans modifier l'article SAP. Stocke aussi conditions livraison et tolérances spécifiques." },
  { id: "exam-47", chapter: "Données de base SD", question: "La Customer Hierarchy en SAP SD :", options: ["Est organisationnelle", "Structure les clients en hiérarchie (groupe / filiales / points de vente) pour prix groupe et reporting consolidé", "Est uniquement pour le crédit", "Est obsolète"], correctIndex: 1, explanation: "Customer Hierarchy modélise les relations parent-enfant entre clients. Application : prix négociés au niveau groupe applicables aux filiales. Important pour grands distributeurs." },
  { id: "exam-48", chapter: "Données de base SD", question: "Dans S/4HANA, un client est créé via :", options: ["XD01", "BP avec rôle FLCU00 (général) et FLCU01 (Customer)", "FD01 uniquement", "MM01"], correctIndex: 1, explanation: "S/4HANA : client = Business Partner avec rôles FLCU00 + FLCU01. XD01/FD01 délèguent à BP en interne. BP est l'unique transaction de gestion." },
  { id: "exam-49", chapter: "Données de base SD", question: "Le Sold-To Party (Donneur d'Ordre) :", options: ["Est le destinataire de la livraison", "Est le partenaire qui passe la commande — point de départ obligatoire de toute commande SD", "Est le payeur", "Est l'agence"], correctIndex: 1, explanation: "Sold-To Party (rôle SP/AG) = client commercial qui passe la commande. Obligatoire. Les autres partenaires (Ship-To WE, Bill-To RE, Payer RG) sont dérivés ou peuvent différer." },
  { id: "exam-50", chapter: "Données de base SD", question: "Le Material Listing/Exclusion :", options: ["Est obligatoire", "Définit pour un client quels articles SONT autorisés (Listing) ou NE SONT PAS autorisés (Exclusion)", "Est l'inventaire", "Liste les commandes"], correctIndex: 1, explanation: "Material Listing = articles autorisés. Material Exclusion = interdits. SAP bloque les commandes hors liste/dans exclusion. Utilisé pour produits réservés à certains canaux." },
  { id: "exam-51", chapter: "Données de base SD", question: "La fiche article vue Ventes 1 contient :", options: ["Les données de stock", "Les données commerciales : statut de vente, unité de vente, groupe d'articles, livraison min", "Les données comptables", "La nomenclature"], correctIndex: 1, explanation: "Vue Ventes 1 (Sales: sales org. 1) : statut de vente, unité de vente, groupe d'articles. Vue Ventes 2 = pricing groups, comptabilisation. Vue Ventes/Plant = shipping point determination." },
  // Ch3 — O2C (+6)
  { id: "exam-52", chapter: "Traitement des commandes de vente (O2C)", question: "Le processus O2C standard est :", options: ["BC → GR → MIRO", "Inquiry → Quotation → Sales Order → Delivery → Picking → PGI → Invoice → Encaissement", "MRP → BC → Production", "Forecast → Stock"], correctIndex: 1, explanation: "Order-to-Cash : VA11 (demande) → VA21 (devis) → VA01 (commande) → VL01N (livraison) → Picking → PGI mouvement 601 → VF01 (facture) → F-28 (encaissement)." },
  { id: "exam-53", chapter: "Traitement des commandes de vente (O2C)", question: "Le PGI (Post Goods Issue) en SAP :", options: ["Crée une commande", "Sort physiquement la marchandise du stock (mouvement 601), génère écriture Débit COGS / Crédit Stock", "Crée la facture", "Confirme la livraison"], correctIndex: 1, explanation: "PGI = sortie physique du stock (mouvement 601). Écriture Débit COGS / Crédit Stock. Étape clé qui transfère la propriété juridique au client (selon Incoterms)." },
  { id: "exam-54", chapter: "Traitement des commandes de vente (O2C)", question: "Available-to-Promise (ATP) en SAP SD :", options: ["Est un type de stock", "Vérifie en temps réel la disponibilité d'un article pour confirmer une date de livraison réaliste", "Est un type de commande", "Bloque les commandes"], correctIndex: 1, explanation: "ATP calcule la disponibilité en intégrant : stock actuel, entrées planifiées, sorties prévues. CO09 affiche la situation ATP. Détermine la date confirmable au client." },
  { id: "exam-55", chapter: "Traitement des commandes de vente (O2C)", question: "Les Item Categories (Catégories de Postes) en SD :", options: ["Sont les types de matériaux", "Déterminent le comportement de la ligne : facturable, livrable, gratuit, statistique", "Sont les types de commande", "Définissent les prix"], correctIndex: 1, explanation: "Item Category contrôle chaque ligne : TAN = standard, TANN = gratuit, TANO = matériel sous-traitance, TAS = service. Détermine livraison, facture, dépréciation stock." },
  { id: "exam-56", chapter: "Traitement des commandes de vente (O2C)", question: "VA01 vs VL01N :", options: ["Identiques", "VA01 = créer commande de vente. VL01N = créer livraison sortante depuis une commande existante", "VA01 facture", "VL01N annule"], correctIndex: 1, explanation: "VA01 saisit la commande client (Sales Order). VL01N crée la livraison sortante (Outbound Delivery), déclenche le picking et la préparation expédition." },
  { id: "exam-57", chapter: "Traitement des commandes de vente (O2C)", question: "Un Sales Contract (Contrat de Vente, VA41) :", options: ["Est une commande spot", "Engage le client sur un volume ou montant total sur une période, les commandes appellent ensuite ce contrat", "Est obligatoire", "Remplace la commande"], correctIndex: 1, explanation: "Sales Contract : accord cadre avec client sur volume/montant pour une période. Les commandes 'release' consomment son volume. Permet de prénégocier conditions." },
  // Ch4 — Pricing (+6)
  { id: "exam-58", chapter: "Détermination des prix et technique de conditions", question: "Une Pricing Procedure définit :", options: ["Les conditions de paiement", "L'ordre des types de conditions appliqués au calcul du prix (PR00 prix, K007 remise, MWST TVA)", "Les modes de transport", "Les délais"], correctIndex: 1, explanation: "Pricing Procedure = séquence ordonnée des types de conditions. Chaque ligne définit étape, type, calcul, sous-totaux, requirements. SAP lit dans l'ordre et applique chaque condition." },
  { id: "exam-59", chapter: "Détermination des prix et technique de conditions", question: "VK11 sert à :", options: ["Créer un client", "Créer un Condition Record — prix, remise, surcharge pour une combinaison spécifique", "Créer une commande", "Calculer la TVA"], correctIndex: 1, explanation: "VK11 crée des Condition Records. Pour PR00 : prix article. Pour K007 : remise client. Pour MWST : taux TVA. Validité par dates. Pricing Procedure cherche ces records lors du calcul." },
  { id: "exam-60", chapter: "Détermination des prix et technique de conditions", question: "Le type de condition K007 dans SAP SD est :", options: ["Un prix article", "Une remise client groupe (% ou montant)", "La TVA", "Un transport"], correctIndex: 1, explanation: "K007 = remise client groupe. PR00 = prix article. K005 = remise client/article. K004 = remise article. MWST = TVA. Comprendre les types de conditions standards est essentiel." },
  { id: "exam-61", chapter: "Détermination des prix et technique de conditions", question: "Une Free Goods condition (article gratuit) :", options: ["Réduit le prix à 0", "Ajoute automatiquement une quantité gratuite (ex: 10 + 1 gratuit). Type NA00 ou NB00", "Est un avoir", "Bloque l'article"], correctIndex: 1, explanation: "Free Goods : ajout d'une quantité gratuite. NA00 (Inclusive — qty supplémentaire dans la même ligne) ou NB00 (Exclusive — nouvelle ligne TANN). Configuration via VBN1." },
  { id: "exam-62", chapter: "Détermination des prix et technique de conditions", question: "Une Surcharge (majoration) en pricing SD :", options: ["Réduit le prix", "Ajoute un montant au prix (transport, taxes, sécurité)", "N'existe pas", "Égale à une remise"], correctIndex: 1, explanation: "Surcharge = condition de calcul positif. KF00 (transport), Z* (personnalisée). Différente d'une remise (calcul négatif). Configurée dans la Pricing Procedure." },
  { id: "exam-63", chapter: "Détermination des prix et technique de conditions", question: "L'Access Sequence (Séquence d'accès) :", options: ["Est un mot de passe", "Définit l'ordre de recherche d'un Condition Record dans les tables, du plus spécifique au plus général", "Définit l'accès aux données", "Est l'ordre de connexion"], correctIndex: 1, explanation: "Access Sequence : SAP cherche les condition records dans l'ordre des tables. Du plus spécifique (client+article+date) au plus général (article seul). Première valeur trouvée appliquée." },
  // Ch5 — Livraisons (+6)
  { id: "exam-64", chapter: "Livraisons et gestion des expéditions", question: "VL10A vs VL01N :", options: ["Identiques", "VL10A = créer livraisons en masse depuis liste (Worklist). VL01N = livraison individuelle", "VL10A annule", "VL01N en masse"], correctIndex: 1, explanation: "VL10A (Outbound Delivery Monitor) liste les commandes en attente et permet création en masse. VL01N traite une commande à la fois. VL10A pour traitement quotidien." },
  { id: "exam-65", chapter: "Livraisons et gestion des expéditions", question: "Le Picking en SAP SD :", options: ["Est la facturation", "Est la préparation physique : choix des articles dans l'entrepôt avec quantités/lots, avant le PGI", "Est la confirmation client", "Est l'inventaire"], correctIndex: 1, explanation: "Picking = phase de préparation : récupération des articles selon la livraison. Géré dans VL02N onglet Picking ou via WM/EWM. Précède le Goods Issue." },
  { id: "exam-66", chapter: "Livraisons et gestion des expéditions", question: "Un Transfer Order (Ordre de Transfert) en WM :", options: ["Est un STO", "Est l'instruction de prélèvement détaillée (par emplacement) générée par le Warehouse Management", "Est une commande client", "Crée un ordre de fabrication"], correctIndex: 1, explanation: "Transfer Order (LT03) = ordre détaillé du WM/EWM avec emplacements précis (storage bin) à prélever. Optimise les déplacements. Confirmation (LT12) déclenche le PGI." },
  { id: "exam-67", chapter: "Livraisons et gestion des expéditions", question: "Le PGI génère l'écriture comptable :", options: ["Débit Stock / Crédit COGS", "Débit COGS / Crédit Stock", "Débit Client / Crédit Vente", "Débit Banque / Crédit Vente"], correctIndex: 1, explanation: "PGI : Débit COGS (Cost of Goods Sold) / Crédit Stock (au prix standard ou MAP). Constate la charge marchandise vendue. La vente sera comptabilisée à la facturation." },
  { id: "exam-68", chapter: "Livraisons et gestion des expéditions", question: "Une Route en SAP SD :", options: ["Est un client", "Définit le mode de transport et les durées (route, mode, transit time)", "Est un type de matériau", "Est un statut"], correctIndex: 1, explanation: "Route = chemin de livraison : transporteur, mode, temps de transit, étapes. SAP utilise la route pour calculer les dates de livraison réalistes (départ, transit, arrivée)." },
  { id: "exam-69", chapter: "Livraisons et gestion des expéditions", question: "La Shipping Condition :", options: ["Est l'Incoterm", "Est un attribut client (livraison standard, express, urgent) qui influence shipping point + route", "Est le mode de paiement", "Est obsolète"], correctIndex: 1, explanation: "Shipping Condition (champ VBKD-VSBED) : préférence client (01 standard, 02 express). SAP l'utilise pour déterminer Shipping Point et Route. Définie dans la fiche client." },
  // Ch6 — Facturation (+5)
  { id: "exam-70", chapter: "Facturation et intégration comptable", question: "VF01 vs VF04 :", options: ["Identiques", "VF01 = créer une facture individuelle. VF04 = créer factures en masse depuis liste (Billing Due List)", "VF04 annule", "VF01 en masse"], correctIndex: 1, explanation: "VF01 facture individuelle référence à 1 livraison/commande. VF04 (Billing Due List) propose toutes les livraisons en attente, traitement en masse — utilisé en run nocturne." },
  { id: "exam-71", chapter: "Facturation et intégration comptable", question: "L'écriture comptable de la facture client :", options: ["Débit Stock / Crédit Vente", "Débit Client / Crédit Vente (et Crédit TVA collectée si applicable)", "Débit Banque / Crédit Client", "Débit COGS / Crédit Stock"], correctIndex: 1, explanation: "Facture (VF01) : Débit Client / Crédit Vente + Crédit TVA collectée. La COGS a été comptabilisée au PGI. La marge = Vente - COGS." },
  { id: "exam-72", chapter: "Facturation et intégration comptable", question: "Un Credit Memo (Avoir client) :", options: ["Augmente la créance client", "Diminue la créance client (retour, geste commercial). Type SD G2, type FI DG", "Est un acompte", "Bloque le client"], correctIndex: 1, explanation: "Credit Memo : pièce avoir réduisant la dette client. Créée via VA01 type CR → VL01N (si retour) → VF01 type G2. Type FI : DG." },
  { id: "exam-73", chapter: "Facturation et intégration comptable", question: "Le Billing Block en SAP SD :", options: ["Bloque toutes les factures", "Bloque la facturation d'une commande/livraison (litige, vérif). Empêche VF01 jusqu'à libération", "Bloque le PGI", "Bloque le client"], correctIndex: 1, explanation: "Billing Block (champ FAKSP) = blocage facturation. Empêche la création de la facture. Posé manuellement (litige) ou auto (controls qualité). Levé via modification commande/livraison." },
  { id: "exam-74", chapter: "Facturation et intégration comptable", question: "L'Intercompany Billing en SAP SD :", options: ["Facture entre deux clients", "Facture entre deux sociétés du même groupe lors d'une commande cross-company. Type IV", "Est obsolète", "Pour clients étrangers"], correctIndex: 1, explanation: "Intercompany Billing (VF01 type IV) : la société émettrice facture la société destinataire lors d'une vente cross-company. Crucial pour reporting consolidé et transfer pricing fiscal." },
  // Ch7 — Crédit/Sorties/Spéciales (+6)
  { id: "exam-75", chapter: "Gestion du crédit, sorties et fonctions spéciales", question: "Le Credit Management (FSCM-CR) :", options: ["Gère uniquement les BC", "Vérifie l'encours client + limite de crédit lors des commandes/livraisons et bloque/avertit en cas de dépassement", "Est obligatoire", "Est égal à la trésorerie"], correctIndex: 1, explanation: "Credit Management : limite de crédit par client. À chaque commande, SAP vérifie : encours + commande > limite ? Bloque ou alerte selon configuration. Réduit le risque crédit." },
  { id: "exam-76", chapter: "Gestion du crédit, sorties et fonctions spéciales", question: "Le Output Determination :", options: ["Définit les sorties physiques", "Détermine automatiquement quels documents (confirmation, facture PDF, EDI) sont émis et à qui", "Configure les imprimantes", "Est obsolète"], correctIndex: 1, explanation: "Output Determination = règles d'émission auto des documents : confirmation commande (BA00), facture PDF (RD00), EDI (LD00). Par type de document, partenaire, support. Config via V/30." },
  { id: "exam-77", chapter: "Gestion du crédit, sorties et fonctions spéciales", question: "Les Returns (Retours) en SAP SD :", options: ["Sont des avoirs", "Sont gérés par un Sales Order type RE → livraison entrante (LR) → facture avoir (RE) ou crédit memo", "N'existent pas", "Sont le PGI inversé"], correctIndex: 1, explanation: "Returns : Sales Order RE → Returns Delivery LR (mvt 651) → soit avoir (G2) soit reprise stock + remboursement. Processus inverse du O2C standard." },
  { id: "exam-78", chapter: "Gestion du crédit, sorties et fonctions spéciales", question: "Une Consignment Sale (vente en consignation) :", options: ["Est une vente standard", "Est un processus en plusieurs étapes : envoi consignation chez le client → consommation → facturation à la consommation", "Est un retour", "Est un avoir"], correctIndex: 1, explanation: "Consignment : KB (fill-up consignation) → KE (issue, facturation à consommation) → KA (pickup retour) ou KR (return). Stock visible chez le client avec type W (special stock)." },
  { id: "exam-79", chapter: "Gestion du crédit, sorties et fonctions spéciales", question: "Le Backorder Processing (BOP) :", options: ["Annule les commandes", "Reaffecte le stock disponible aux commandes selon priorités (importance client, date) quand stock insuffisant", "Bloque les retours", "Est manuel"], correctIndex: 1, explanation: "Backorder Processing : algorithme de réaffectation du stock disponible selon priorités (importance client, date promesse, type commande). Important pour gérer les ruptures." },
  { id: "exam-80", chapter: "Gestion du crédit, sorties et fonctions spéciales", question: "Le Material Determination (Substitution) :", options: ["Crée un nouveau matériau", "Substitue automatiquement un matériau saisi par un autre selon des règles (EOL, upgrade)", "Bloque l'article", "Est l'inventaire"], correctIndex: 1, explanation: "Material Determination : règles de substitution auto. Le commercial saisit l'ancien article, SAP substitue par le nouveau. Cas : EOL, upgrade packaging, code générique → spécifique. Config via VB11." },
];
