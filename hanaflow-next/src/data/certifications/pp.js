...
export const ppMockExamQuestions = [
  ...
  // ─── Questions complémentaires (pp-e41 à pp-e80) ─────────────────
  // Ch1 — Structures (+5)
  { id: "pp-e41", chapter: "ch1", question: "Le Work Center (Poste de Charge) en SAP PP :", options: ["Égal à un magasin", "Représente une ressource de production (machine, atelier, équipe). Caractérisé par capacité, formules de coût, calendrier", "Égal à un centre de coûts", "Inutilisé"], correctIndex: 1, explanation: "Work Center (CR01/CR02) : ressource physique (machine) ou organisationnelle (équipe, atelier). Capacité quotidienne (heures/jour), formules de calcul de coût, calendrier de fonctionnement. Référencé dans le routing." },
  { id: "pp-e42", chapter: "ch1", question: "La hiérarchie des postes de charge (Work Center Hierarchy) :", options: ["Inutilisée", "Permet d'agréger des postes de charge en hiérarchie pour reporting capacité globale (atelier → ligne → machine)", "Obsolète", "Égal à BOM"], correctIndex: 1, explanation: "Work Center Hierarchy (CR21) : structure parent-enfant. Atelier → Lignes → Machines. Permet reporting capacité agrégée (charge globale atelier vs détail machine). Utile pour planification capacitaire." },
  { id: "pp-e43", chapter: "ch1", question: "Le calendrier d'usine (Factory Calendar) :", options: ["Inutile", "Définit jours travaillés/fériés/exceptionnels d'une division. Utilisé par Work Centers et MRP pour planning", "Limité aux RH", "Obsolète"], correctIndex: 1, explanation: "Factory Calendar (SCAL) : calendrier de production. Jours ouvrables, fériés, exceptions (maintenance programmée, congés annuels). Affecté à la division. Le MRP et les Work Centers s'y réfèrent pour planifier." },
  { id: "pp-e44", chapter: "ch1", question: "Le Capacity Category :", options: ["Inutile", "Type de capacité d'un Work Center : 001 Capacity Hommes, 002 Machines. Permet plusieurs capacités par poste", "Obsolète", "Égal au calendrier"], correctIndex: 1, explanation: "Capacity Category : un Work Center peut avoir plusieurs capacités (002 Machines, 001 MOD). Chacune avec son nombre d'unités, formules. Permet de modéliser : 1 machine + 2 opérateurs simultanés." },
  { id: "pp-e45", chapter: "ch1", question: "Le Plant Maintenance Plant (PM-Plant) :", options: ["Toujours différent du PP-Plant", "Souvent identique à la division PP. Gère les ordres de maintenance qui peuvent bloquer temporairement les Work Centers", "Inexistant", "Égal au PA"], correctIndex: 1, explanation: "PM (Plant Maintenance) gère la maintenance des Work Centers. Maintenance planifiée bloque les capacités sur le créneau. PP doit en tenir compte (intégration PM-PP). Souvent même Plant pour PP et PM." },
  // Ch2 — BOM & Routing (+6)
  { id: "pp-e46", chapter: "ch2", question: "Une BOM (Bill of Materials / Nomenclature) :", options: ["Liste de prix", "Liste structurée des composants nécessaires pour fabriquer un produit. Multi-niveaux (sub-assemblies). Créée par CS01", "Liste de fournisseurs", "Recette de cuisine"], correctIndex: 1, explanation: "BOM (Stuckliste) = nomenclature : composants requis pour 1 unité de produit. Multi-niveaux : produit fini → semi-finis → matières premières. CS01/CS02 = créer/modifier. Critique pour MRP et Product Costing." },
  { id: "pp-e47", chapter: "ch2", question: "BOM Usage (Domaine d'application) :", options: ["Inutile", "Catégorise la BOM : 1=Production, 5=Sales, 7=Service, etc. Permet plusieurs BOMs pour le même produit selon usage", "Obsolète", "Égal au type d'article"], correctIndex: 1, explanation: "BOM Usage : un même produit peut avoir BOM de production (Usage 1), BOM de vente (Usage 5 — packaging différent), BOM de service. SAP sélectionne la bonne selon le contexte (ordre fab vs commande client)." },
  { id: "pp-e48", chapter: "ch2", question: "Le Routing (Gamme de fabrication) :", options: ["Itinéraire de transport", "Séquence des opérations de fabrication avec Work Centers, temps standards (setup, machine, MOD), composants par opération", "Routage réseau", "Obsolète"], correctIndex: 1, explanation: "Routing (CA01) : process gamme. Liste ordonnée d'opérations (Operation 0010 Découpe, 0020 Soudure, 0030 Peinture) avec Work Center, temps unitaires, qty composants à consommer. Base du calcul coût et planning capacitaire." },
  { id: "pp-e49", chapter: "ch2", question: "Le Reference Operation Set :", options: ["Inutilisé", "Bloc d'opérations réutilisable inséré dans plusieurs routings. Évite duplication, facilite maintenance", "Obsolète", "Égal au routing"], correctIndex: 1, explanation: "Reference Operation Set (CA11) : modèle d'opérations standardisé (ex: 'Test Qualité Standard') référencé dans plusieurs routings. Modification du modèle se propage à tous les routings utilisateurs. DRY pour les gammes." },
  { id: "pp-e50", chapter: "ch2", question: "Le Production Version :", options: ["Inutile", "Combine une BOM + un Routing pour un produit. Permet plusieurs versions (procédés alternatifs) avec validité temporelle", "Égal au BOM", "Obsolète"], correctIndex: 1, explanation: "Production Version (C223) : couple BOM + Routing valide pour un matériau et une période. Permet de gérer alternatives (procédé classique vs procédé éco), changements de design avec dates de validité." },
  { id: "pp-e51", chapter: "ch2", question: "L'Engineering Change Management (ECM) :", options: ["Inutile", "Trace les modifications BOM/Routing avec ECN (Engineering Change Number). Validité par dates, traçabilité, validation", "Égal à GIT", "Obsolète"], correctIndex: 1, explanation: "ECM (CC01) : gère les modifications structurées. ECN porte le contexte (raison, dates, approbations). Toute modif BOM/Routing référence un ECN. Permet de tracer 'pourquoi' et 'depuis quand' chaque changement." },
  // Ch3 — MRP & Planning (+6)
  { id: "pp-e52", chapter: "ch3", question: "Le PIR (Planned Independent Requirement) :", options: ["Égal à une PR", "Besoin indépendant prévisionnel saisi pour les produits finis (forecast). Alimente le MRP. MD61 pour création", "Égal à une commande", "Inutilisé"], correctIndex: 1, explanation: "PIR (Planned Independent Requirement) : prévision de besoin pour produits finis. Saisi manuellement (MD61) ou généré par module SOP/PP-DS. Le MRP les utilise comme déclencheur (avec commandes clients) pour planifier." },
  { id: "pp-e53", chapter: "ch3", question: "Le MRP Live S/4HANA :", options: ["Identique au MRP classique", "Exécute la planification directement dans HANA via procédures stockées. Performance × 5-10 vs MRP classique", "Plus lent", "Obsolète"], correctIndex: 1, explanation: "MRP Live (MD01N) : nouvelle architecture S/4HANA. Calcul direct dans HANA (in-memory) via procédures stockées. Performance ×5-10. Permet de planifier des millions d'articles en quelques minutes vs heures en ECC." },
  { id: "pp-e54", chapter: "ch3", question: "Une Stratégie de Planification 10 (Make-to-Stock pure) :", options: ["Production sur commande", "Production sur prévision pure. Stock alimenté à l'avance. Ventes prélevées du stock", "Hybride", "Configuration spéciale"], correctIndex: 1, explanation: "Stratégie 10 = Make-to-Stock pure : produire stock anticipé sur prévisions, ventes prélèvent du stock. Délai client = délai expédition (court). Risque : stock invendu si prévisions fausses." },
  { id: "pp-e55", chapter: "ch3", question: "Une Stratégie 20 (Make-to-Order) :", options: ["Production sur prévisions", "Production uniquement sur commande client. Pas de stock anticipé. Délai client = délai production", "Hybride", "Égal à MTS"], correctIndex: 1, explanation: "Stratégie 20 = MTO pur : production démarrée à la commande client. Pas de stock anticipé. Délai client = délai production complet. Utilisé pour produits configurés/customisés (machines spéciales, projets)." },
  { id: "pp-e56", chapter: "ch3", question: "Une Planned Order (Ordre planifié) :", options: ["Bon de commande", "Proposition de fabrication créée par MRP. Convertible en Production Order (réelle) par le planificateur. Modifiable", "Égal à une PR", "Inutilisé"], correctIndex: 1, explanation: "Planned Order : sortie du MRP pour production interne. Modifiable (date, qty) sans impact réel. CO40 ou MD04 pour la convertir en Production Order (engagement réel des ressources et matières)." },
  { id: "pp-e57", chapter: "ch3", question: "Le MPS (Master Production Scheduling) :", options: ["Inutile", "Planification dédiée aux articles stratégiques (M0/M1/M2). Validation manuelle avant déclenchement MRP des composants", "Égal à MRP", "Obsolète"], correctIndex: 1, explanation: "MPS = MRP avec validation manuelle pour les articles stratégiques (produits finis principaux, composants critiques). Le planificateur valide les propositions avant déclenchement MRP des composants. Stabilise la production." },
  // Ch4 — Production Orders (+6)
  { id: "pp-e58", chapter: "ch4", question: "CO01 vs CO40 :", options: ["Identiques", "CO01 = créer manuellement un ordre de fabrication. CO40 = convertir une Planned Order en Production Order", "CO40 affiche", "CO01 supprime"], correctIndex: 1, explanation: "CO01 : création manuelle d'un Production Order (cas exceptionnel). CO40 : conversion d'une Planned Order MRP en Production Order — flux standard. CO02 modifie un ordre existant." },
  { id: "pp-e59", chapter: "ch4", question: "Le statut REL (Released) d'un Production Order :", options: ["Créé", "Libéré : peut commencer à recevoir confirmations, sorties matières, mouvements stock. État opérationnel", "Clos", "Inutilisé"], correctIndex: 1, explanation: "Statut REL = Released. L'ordre peut maintenant être exécuté en atelier : sorties composants (mvt 261), confirmations d'opérations (CO11N), entrée stock produit fini (mvt 101 contre ordre). Statuts : CRTD → REL → CNF → DLV → TECO." },
  { id: "pp-e60", chapter: "ch4", question: "La sortie composants (Goods Issue) sur ordre de production :", options: ["Mouvement 101", "Mouvement 261 (Goods Issue for Production Order). Décrémente stock composants, impute coûts à l'ordre", "Mouvement 311", "Mouvement 551"], correctIndex: 1, explanation: "Mouvement 261 = sortie pour ordre de production. Décrémente stock composants, génère écriture Débit Ordre (compte 6xxxx) / Crédit Stock. Impute le coût matière à l'ordre — base du calcul de coût réel." },
  { id: "pp-e61", chapter: "ch4", question: "La confirmation d'opération CO11N :", options: ["Inutile", "Saisie par l'opérateur : qty produite, temps réels (setup, machine, MOD), opérateur. Met à jour avancement, coûts réels", "Égal à PGI", "Obsolète"], correctIndex: 1, explanation: "CO11N (Time Ticket) : confirmation par opération. Saisit les quantités produites/rebutées, temps réels par activity type, identifiant opérateur. Met à jour le statut et impute les coûts d'activité réels à l'ordre." },
  { id: "pp-e62", chapter: "ch4", question: "Le Backflushing (Auto Goods Issue) :", options: ["Manuel", "Sortie automatique des composants au moment de la confirmation. Évite la saisie manuelle. Configuré sur le composant", "Obsolète", "Inutile"], correctIndex: 1, explanation: "Backflushing : flag dans la BOM/composant. À la confirmation de l'opération qui consomme ce composant, SAP génère automatiquement le mouvement 261. Réduit la saisie en atelier — utilisé en production série haute cadence." },
  { id: "pp-e63", chapter: "ch4", question: "Le statut DLV (Delivered) :", options: ["Créé", "Toute la quantité commandée a été produite et entrée en stock (mouvement 101). Ordre techniquement terminé", "Erreur", "Annulé"], correctIndex: 1, explanation: "Statut DLV (Delivered) = ordre fini : qty totale produite et reçue en stock. Reste à clôturer techniquement (TECO) puis financièrement (CO88) en clôture mensuelle pour solder les écarts." },
  // Ch5 — Capacity Planning (+4)
  { id: "pp-e64", chapter: "ch5", question: "CR05 (Capacity Overview) :", options: ["Crée Work Center", "Affiche la charge prévue d'un Work Center vs capacité disponible. Identifie les surcharges/sous-charges", "Égal à MRP", "Obsolète"], correctIndex: 1, explanation: "CR05 (Capacity Load Overview) : tableau de bord planificateur capacités. Pour chaque Work Center, affiche par jour/semaine : charge planifiée vs capacité disponible. Couleur si surcharge (>100%). Outil de leveling." },
  { id: "pp-e65", chapter: "ch5", question: "Le Capacity Leveling (Lissage de capacité) :", options: ["Inutile", "Ajuste les ordres pour résoudre les surcharges : déplacer dans le temps, splitter, sous-traiter. CM21 vue heatmap", "Manuel uniquement", "Obsolète"], correctIndex: 1, explanation: "Capacity Leveling : équilibrage charge/capacité. CM21 (Capacity Planning Table) : vue heatmap interactive, drag-and-drop pour replanifier ordres. Outils : split, dispatching automatique selon règles (priority, due date)." },
  { id: "pp-e66", chapter: "ch5", question: "PP/DS (Production Planning and Detailed Scheduling) :", options: ["Égal à MRP", "Module avancé de planification fine et ordonnancement détaillé. Optimisation algorithmique (genetic, heuristics). S/4HANA embedded", "Obsolète", "Cloud uniquement"], correctIndex: 1, explanation: "PP/DS : ex APO module désormais embedded dans S/4HANA. Planification fine à la seconde, optimisation algorithmique (algorithmes génétiques, heuristiques). Pour planning complexe multi-contraintes (séquencement, setup, ressources rares)." },
  { id: "pp-e67", chapter: "ch5", question: "Le Finite Scheduling (Planification finie) :", options: ["Capacité illimitée", "Respecte la capacité réelle disponible — décale les ordres si surcharge. Plus réaliste mais plus complexe", "Manuel", "Obsolète"], correctIndex: 1, explanation: "Finite Scheduling : opposé d'Infinite (qui ignore capacités). Respecte capacités réelles, décale ordres en surcharge. Plus réaliste pour planning exécutable en atelier mais plus contraignant. Activé par planificateur." },
  // Ch6 — Manufacturing Variants (+4)
  { id: "pp-e68", chapter: "ch6", question: "Le Process Order (Ordre de fabrication chimique/process) :", options: ["Égal à Production Order", "Variante pour industries process (chimie, pharma, agro). Master Recipe (vs Routing), gestion lots batch", "Obsolète", "Égal à STO"], correctIndex: 1, explanation: "Process Order (PP-PI Process Industry) : pour industries process. Master Recipe (vs Routing discret), Phase (vs Operation), Resource (vs Work Center), gestion stricte des lots, contrôles qualité par opération." },
  { id: "pp-e69", chapter: "ch6", question: "Le Repetitive Manufacturing (Production en Série) :", options: ["Égal à Production Order", "Production série haute cadence sans Production Orders. Backflushing systématique. Confirmation au niveau ligne, pas opération", "Obsolète", "Limitée à pharma"], correctIndex: 1, explanation: "Repetitive Manufacturing : pour production série (auto, électronique). Pas de Production Orders individuels — Run Schedule Quantity. Backflushing automatique. Plus simple mais moins traçable que Discrete Manufacturing." },
  { id: "pp-e70", chapter: "ch6", question: "Le KANBAN en SAP PP :", options: ["Manuel", "Méthode lean : carte virtuelle (Kanban Card) entre supplier/consumer. Réapprovisionnement automatique au consommé. PK13N Kanban Board", "Obsolète", "Égal à MRP"], correctIndex: 1, explanation: "KANBAN SAP : digitalisation des cartes physiques. Quand consumer consomme, statut Kanban passe Empty → Wait → Refill. Déclenche automatiquement réappro (BC, ordre fab interne). Pull-flow lean." },
  { id: "pp-e71", chapter: "ch6", question: "Lean Manufacturing avec SAP :", options: ["Incompatible", "Combinaison Repetitive Manufacturing + KANBAN + Backflushing pour flux pull continu. Réduit stocks, simplifie process", "Obsolète", "Égal à MRP"], correctIndex: 1, explanation: "Lean Manufacturing SAP : Repetitive Mfg pour production simplifiée + KANBAN pour réappro pull + Backflushing pour saisie auto. Réduit work-in-process, accélère cycle, simplifie atelier. Adopté massivement automotive." },
  // Ch7 — Closing & Reporting (+9)
  { id: "pp-e72", chapter: "ch7", question: "TECO (Technically Complete) sur Production Order :", options: ["Validé", "Statut technique : pas de nouvelles imputations possibles, mais ordre encore solde-able. Étape avant CLSD", "Erreur", "Annulé"], correctIndex: 1, explanation: "TECO = Technically Complete. L'ordre est terminé techniquement mais reste comptablement ouvert pour le solde des écarts. Bloque nouvelles imputations. Solde via KKS2 (calcul écarts) puis CO88 (settlement) puis CLSD." },
  { id: "pp-e73", chapter: "ch7", question: "KKS2 (Variance Calculation) :", options: ["Crée ordre", "Calcule les écarts de production : Input Price, Quantity, Resource-Usage, Lot Size, Mixed Price. En masse pour clôture", "Annule ordre", "Obsolète"], correctIndex: 1, explanation: "KKS2 calcule en masse les écarts des Production Orders en clôture mensuelle. KKS1 individuel. Génère breakdown des écarts par catégorie (prix matière, qty consommée, mix activités, taille lot)." },
  { id: "pp-e74", chapter: "ch7", question: "CO88 (Settlement) sur ordre fab :", options: ["Crée ordre", "Solde l'ordre : transfère les écarts vers CO-PA (analyse) ou compte d'écart en GL. Selon Settlement Profile", "Calcule prix", "Obsolète"], correctIndex: 1, explanation: "CO88 (Settlement) solde les écarts de production : selon Settlement Profile, écarts vont vers CO-PA (analyse rentabilité par produit/client) ou comptes GL d'écart. Étape finale de clôture coûts produit." },
  { id: "pp-e75", chapter: "ch7", question: "Le rapport CO03 :", options: ["Crée ordre", "Affiche un Production Order avec ses statuts, opérations, composants, confirmations, coûts. Lecture seule", "Inutilisé", "Obsolète"], correctIndex: 1, explanation: "CO03 (Display Production Order) : vue lecture-seule de l'ordre. Toutes les données : header, opérations, composants, confirmations, coûts plan/réel/écarts. Outil de référence pour tout responsable production/contrôle." },
  { id: "pp-e76", chapter: "ch7", question: "L'Order Information System (OIS) :", options: ["Inexistant", "Suite de rapports (COOIS, COHV) pour analyser les ordres : sélection multi-critères, drill-down, export Excel", "Obsolète", "Manuel uniquement"], correctIndex: 1, explanation: "OIS : COOIS (Order Information System) liste les ordres selon critères (statut, période, plant). COHV (Mass Processing) : sélection puis actions en masse (release, TECO, print). Outils quotidien planificateur." },
  { id: "pp-e77", chapter: "ch7", question: "Manufacturing Execution System (MES) :", options: ["Égal à PP", "Système atelier connecté à SAP : pilotage temps-réel des machines, traçabilité, scheduling fin. Intégration via SAP-PCo ou MII", "Obsolète", "Limité au cloud"], correctIndex: 1, explanation: "MES : couche atelier (Apriso, Werum, etc.) entre PP/SAP et machines. Pilotage temps-réel, IoT, scheduling fin. Intégration via SAP MII (Manufacturing Intelligence) ou SAP-PCo (Plant Connectivity)." },
  { id: "pp-e78", chapter: "ch7", question: "Le Quality Management (QM) en intégration PP :", options: ["Indépendant", "Inspection lots à la GR composant (mvt 101 → stock QI), inspection finale produits, traçabilité qualité", "Obsolète", "Manuel"], correctIndex: 1, explanation: "QM-PP : à la réception composant, possibilité d'inspection. Stock va en QI (Quality Inspection) avant libération. Production avec contrôles in-process (test après opération clé). Stock fini possiblement en QI avant disponibilité commerciale." },
  { id: "pp-e79", chapter: "ch7", question: "Apps Fiori Manufacturing S/4HANA :", options: ["Inexistantes", "'Confirm Production Operations', 'Monitor Production Orders', 'Monitor Capacity Utilization' — UX moderne pour atelier et planificateurs", "Obsolète", "Manuelles"], correctIndex: 1, explanation: "Apps Fiori PP : 'Confirm Production Operations' (saisie atelier tablette), 'Monitor Production Orders' (KPIs visuels), 'Monitor Capacity Utilization' (heatmap capacités). UX moderne tactile mobile-friendly." },
  { id: "pp-e80", chapter: "ch7", question: "L'IoT et l'Industry 4.0 dans SAP PP :", options: ["Inexistant", "Intégration capteurs machines via SAP IoT/Edge → Production Orders mis à jour temps réel. Predictive maintenance, OEE", "Obsolète", "Limité"], correctIndex: 1, explanation: "Industry 4.0 SAP : capteurs machines → SAP IoT Edge → Production Orders auto-confirmés selon production réelle. Predictive Maintenance ML, calcul OEE temps réel. Vision 'usine connectée' avec digital twin." },
];
