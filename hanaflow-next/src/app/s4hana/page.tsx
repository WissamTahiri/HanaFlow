...
const S4HANAOverview = () => {
  return (
    <div className="min-h-[calc(100vh-4rem)]">
      {/* Hero */}
      <div className="bg-linear-to-br from-indigo-900 via-indigo-700 to-violet-500 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <nav className="flex items-center gap-2 text-xs text-white/60 mb-6" aria-label="Fil d'Ariane">
            ...
            <span>/</span>
            <span className="text-white/90">S/4HANA</span>
          </nav>
          <div className="inline-flex items-center gap-2 mb-4">
            <span className="px-3 py-1 rounded-full text-xs font-bold bg-white/20 border border-white/30 backdrop-blur-sm">S/4HANA</span>
            <span className="text-xs text-white/70">ERP nouvelle génération · SAP HANA · Fiori</span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 leading-tight">SAP S/4HANA</h1>
          <p className="text-base sm:text-lg text-white/80 max-w-2xl leading-relaxed">
            L&apos;ERP de nouvelle génération de SAP : in-memory, Fiori, Universal Journal et analytique temps réel. Comprendre S/4HANA, c&apos;est comprendre l&apos;avenir de tous les projets SAP.
          </p>
        </div>
      </div>
      {/* Contenu */}
