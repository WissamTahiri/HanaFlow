...
function DashboardContent() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50 dark:bg-sap-dark py-8 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        >
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-4">
              <div className="h-14 w-14 rounded-2xl bg-linear-to-br from-sap-blue to-sap-blue-dark
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2 flex-wrap">
                  <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full bg-sap-100 text-sap-blue">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <Link href="/profil" className="btn-ghost text-sm px-4 py-2 rounded-xl border border-gray-200 dark:border-slate-600">
                Mon profil
              </Link>
              <button
        ...
        >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card p-5">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-9 h-9 rounded-xl bg-sap-blue/10 dark:bg-sap-blue/20 flex items-center justify-center text-sap-blue dark:text-sap-accent">
                <BookIcon />
              </div>
            ...
            <div className="mt-3 w-full h-1.5 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden">
              <motion.div
                ...
                className="h-full rounded-full bg-linear-to-r from-sap-blue to-sap-accent"
              />
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card p-5">
            ...
            {fiLessonsCompleted > 0 ? (
              ...
              <>
                ...
                <Link
                  href="/certifications/fi"
                  className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-sap-blue dark:text-sap-accent hover:underline"
                >
            ...
            {isPro ? (
              ...
              <>
                ...
                <button
                  ...
                  className="mt-3 text-xs font-semibold text-sap-blue dark:text-sap-accent hover:underline inline-flex items-center gap-1"
                >
        ...
        >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/achievements" className="text-xs text-sap-blue dark:text-sap-accent hover:underline font-medium">
                Voir tout
              </Link>
            </div>
        ...
        {nextModule && (
          ...
          >
            <Link
              ...
              className="flex items-center justify-between gap-4 bg-linear-to-r from-sap-blue to-sap-blue-dark
        ...
        {percentage === 100 && (
          ...
          >
            ...
            <Link href="/certifications" className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-emerald-700 dark:text-emerald-400 hover:underline">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/modules-sap" className="text-xs text-sap-blue dark:text-sap-accent hover:underline font-medium">
              Voir tout
            </Link>
          </div>
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 p-3.5 rounded-xl border transition-all duration-200
                              ...
                              ${visited
                                ...
                                : "border-gray-100 dark:border-slate-700 hover:border-sap-blue/30 dark:hover:border-sap-blue/30"
                              }`}
                >
                  ...
                  <span className={`text-xs flex-shrink-0 transition-all
                                   ${visited
                                     ...
                                     : "text-slate-300 group-hover:text-sap-blue dark:group-hover:text-sap-accent"
                                   }`}>
