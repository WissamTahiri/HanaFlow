      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2.5 justify-center mb-4">
            <div className="h-10 w-10 rounded-xl bg-linear-to-br from-sap-blue to-sap-blue-dark flex items-center justify-center text-sm font-bold text-white shadow-soft">
              HF
            </div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Gratuit, sans carte bancaire.</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card p-8">
          ...
          <p className="mt-5 text-sm text-center text-slate-500 dark:text-slate-400">
            Déjà un compte ?{" "}
            <Link href="/login" className="font-semibold text-sap-blue dark:text-sap-accent hover:underline">
              Se connecter
            </Link>
          </p>
        </div>
