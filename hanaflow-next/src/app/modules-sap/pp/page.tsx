...
const KEY_CONCEPTS = [
  ...
  { code: "PP/DS", label: "MRP Live / PP/DS", description: "En S/4HANA, MRP Live permet une planification temps réel avec prise en compte des contraintes capacitaires et feedback immédiat de l'exécution.", color: "bg-sap-blue/5 dark:bg-sap-blue/10 border-sap-blue/20 dark:border-sap-blue/30 text-sap-blue dark:text-sap-accent" },
];
...
const CareerBenefits = () => (
  <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.14 }}
    className="bg-linear-to-br from-teal-900 to-teal-600 rounded-2xl p-6 text-white">
