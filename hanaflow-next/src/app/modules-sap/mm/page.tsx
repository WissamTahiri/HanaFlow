...
const KEY_CONCEPTS = [
  ...
  { code: "MATDOC", label: "Material Document",                 description: "En S/4HANA, table unique MATDOC remplace plusieurs tables ECC pour les mouvements de stock. Reporting simplifié et temps réel.", color: "bg-sap-blue/5 dark:bg-sap-blue/10 border-sap-blue/20 dark:border-sap-blue/30 text-sap-blue dark:text-sap-accent" },
];
