...
const KEY_CONCEPTS = [
  ...
  { code: "CO-PA", label: "Profitability Analysis", description: "Analyse de la rentabilité par dimensions métier : client, produit, région, canal de vente. Cœur du reporting de marge.", color: "bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800/50 text-amber-700 dark:text-amber-400" },
