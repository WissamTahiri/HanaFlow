...
const KEY_CONCEPTS = [
  { code: "CCA", label: "Cost Center Accounting", description: "Suivi des coûts par unité de responsabilité (service IT, production, RH…). Permet de comparer coûts planifiés et réels.", color: "bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800/50 text-emerald-700 dark:text-emerald-400" },
  { code: "PCA", label: "Profit Center Accounting", description: "Suivi des profits par business unit, ligne de produits ou région. Donne une vision P&L interne par segment.", color: "bg-teal-50 dark:bg-teal-900/20 border-teal-200 dark:border-teal-800/50 text-teal-700 dark:text-teal-400" },
  { code: "IO",  label: "Internal Orders", description: "Objets temporaires pour suivre les coûts d'un projet, d'une campagne ou d'un événement avant de les solder vers d'autres objets CO.", color: "bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800/50 text-blue-700 dark:text-blue-400" },
  { code: "CO-PC", label: "Product Cost Controlling", description: "Calcul du coût standard des produits fabriqués. Suit le WIP (Work in Progress) et les variances sur ordres de production.", color: "bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800/50 text-purple-700 dark:text-purple-400" },
  { code: "CO-PA", label: "Profitability Analysis", description: "Analyse de la rentabilité par dimensions métier : client, produit, région, canal de vente. Cœur du reporting de marge.", color: "bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800/50 text-orange-700 dark:text-orange-400" },
  { code: "ACDOCA", label: "Universal Journal", description: "En S/4HANA, FI et CO partagent la même table ACDOCA. Fini la réconciliation — le reporting est temps réel.", color: "bg-sap-blue/5 dark:bg-sap-blue/10 border-sap-blue/20 dark:border-sap-blue/30 text-sap-blue dark:text-sap-accent" },
];
  ...
  <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.08 }}
    ...
    <div className="grid sm:grid-cols-2 gap-5">
      <div className="space-y-3">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300">Chaque coût (salaires, loyers, fournitures) est affecté à un cost center. Les managers analysent les écarts entre budget et réalisé.</p>
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300">Les profit centers permettent de produire un P&L interne par ligne de produits, par région ou par business unit.</p>
        <ul className="space-y-1 text-sm text-slate-600 dark:text-slate-300">
...
const CoPaSection = () => (
  <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }}
    ...
    <p className="text-sm text-slate-500 dark:text-slate-400 mb-5">CO-PA permet d'analyser la rentabilité par dimensions métier : client, produit, région, canal de distribution.</p>
...
const CareerBenefits = () => (
  <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.14 }}
    className="bg-linear-to-br from-emerald-900 to-emerald-700 rounded-2xl p-6 text-white">
