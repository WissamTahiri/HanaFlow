...
const KEY_CONCEPTS = [
  ...
  { code: "PY", label: "Payroll", description: "Calcul des salaires en tenant compte des heures, absences, primes et déductions. Génère des écritures FI (charges sociales, salaires nets, comptabilité).", color: "bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800/50 text-amber-700 dark:text-amber-400" },
  ...
  { code: "EC", label: "Employee Central", description: "Core HR cloud dans SuccessFactors. Gère les données maîtres employés dans le cloud, souvent intégré à S/4HANA Finance et Payroll on-premise.", color: "bg-sap-blue/5 dark:bg-sap-blue/10 border-sap-blue/20 dark:border-sap-blue/30 text-sap-blue dark:text-sap-accent" },
];
  ...
  <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }}
    ...
    <div className="grid sm:grid-cols-3 gap-4 mb-5">
      {[
        ...
        { module: "Joule in SF", desc: "Intégration de l'IA générative : explication de la paie, assistance RH admin, analytics emploi.", color: "bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800/40 text-amber-700 dark:text-amber-400" },
...
const CareerBenefits = () => (
  <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.12 }}
    className="bg-linear-to-br from-red-900 to-rose-700 rounded-2xl p-6 text-white">
