...
const KEY_CONCEPTS = [
  ...
  },
  {
    ...
    color: "bg-sap-blue/5 dark:bg-sap-blue/10 border-sap-blue/20 dark:border-sap-blue/30 text-sap-blue dark:text-sap-accent",
  },
  {
    code: "O2C",
    label: "Order-to-Cash",
    ...
    <div className="grid sm:grid-cols-2 gap-4">
      {[
        ...
        <div key={term} className="flex gap-3 p-4 rounded-xl bg-gray-50 dark:bg-slate-700/50 border border-gray-100 dark:border-slate-700">
          <div className="w-2 h-2 rounded-full bg-sap-blue mt-2 flex-shrink-0" />
          <div>
  ...
  >
    ...
    <div className="space-y-3">
      {[
        ...
        <div key={title} className="flex gap-3 p-4 rounded-xl bg-sap-blue/5 dark:bg-sap-blue/10 border border-sap-blue/20">
          <div className="w-2 h-2 rounded-full bg-sap-blue mt-2 flex-shrink-0" />
          <div>
...
const CareerBenefits = () => (
  <motion.section
    ...
    className="bg-linear-to-br from-sap-blue-dark to-sap-blue rounded-2xl p-6 text-white"
  >
...
const FiTcodes = () => (
  ...
  >
    ...
    <div className="grid sm:grid-cols-2 gap-3">
      {TCODES.map((t) => (
        <div key={t.code} className="border border-sap-blue/20 rounded-xl p-4 bg-sap-blue/5 dark:bg-sap-blue/10">
          <p className="text-xs font-bold text-sap-blue dark:text-sap-accent mb-1">{t.code} — {t.label}</p>
          ...
          <div key={q.id} className="border border-gray-100 dark:border-slate-700 rounded-xl p-4">
            ...
            <div className="space-y-2">
              {q.options.map((opt, idx) => {
                ...
                if (!submitted) {
                  cls += selected
                    ? "border-sap-blue bg-sap-blue/10 text-sap-blue dark:text-sap-accent font-medium"
                    : "border-gray-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:border-sap-blue/40 hover:bg-sap-blue/5";
                } else if (isCorrect) {
    ...
    <div className="grid sm:grid-cols-2 gap-3">
      {RESOURCES.map((r) => (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex flex-col gap-1 p-4 rounded-xl border border-gray-100 dark:border-slate-700 hover:border-sap-blue/40 hover:shadow-md transition-all group"
        >
          <span className="text-xs text-sap-blue dark:text-sap-accent font-medium">{r.source}</span>
          <span className="text-sm font-medium text-slate-800 dark:text-slate-200 group-hover:text-sap-blue dark:group-hover:text-sap-accent transition-colors leading-snug">
            {r.title}
          </span>
        </a>
      ))}
