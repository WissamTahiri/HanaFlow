...
function ProfileContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-sap-dark py-8 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto space-y-6">

        <Link href="/dashboard" className="inline-flex items-center gap-1.5 text-sm text-sap-blue dark:text-sap-accent hover:underline">
          ← Retour au dashboard
        </Link>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card overflow-hidden">
          <div className="h-20 bg-linear-to-r from-sap-blue-dark to-sap-blue" />
          <div className="px-6 pb-6">
            <div className="flex items-end justify-between -mt-8 mb-4">
              <div className="h-16 w-16 rounded-2xl bg-linear-to-br from-sap-blue to-sap-blue-dark
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-sap-blue text-white rounded-xl font-medium text-sm
                         hover:bg-sap-blue-dark transition-colors disabled:opacity-50"
            >
