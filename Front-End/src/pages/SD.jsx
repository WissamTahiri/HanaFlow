...
const KEY_CONCEPTS = [
  ...
  { code: "RAR", label: "Revenue Accounting", description: "Reconnaissance de revenus avancée selon IFRS 15 / ASC 606. Intégré à SD et FI pour les contrats complexes ou multi-éléments.", color: "bg-sapBlue/5 dark:bg-sapBlue/10 border-sapBlue/20 dark:border-sapBlue/30 text-sapBlue dark:text-sapAccent" },
];
