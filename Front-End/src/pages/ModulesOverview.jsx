...
const ModulesOverview = () => {
  ...
  return (
    <>
      <SEO
        title="Modules SAP"
        description="Panorama complet des modules SAP : FI, CO, MM, SD, HCM, PP. Difficulté, prérequis, parcours recommandé et suivi de progression."
        path="/modules-sap"
      />
      ...
      {/* ── Filtres (sticky) ────────────────────────────────── */}
      <div className="sticky top-16 z-20 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 shadow-sm">
          ...
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm rounded-xl border border-gray-200 dark:border-slate-700
                         ...
                         focus:outline-none focus:ring-2 focus:ring-sapBlue/40 placeholder:text-slate-400"
            />
          </div>
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-medium
                                ...
                                ${visited
                                  ...
                                  : "bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:border-sapBlue/40"
                                }`}
                  >
                    {visited && <CheckIcon />}
