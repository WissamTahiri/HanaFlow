...
export default function ExamSimulatorPP() {
  ...
  if (!canAccess(true)) {
    return (
      <>
        ...
        <div className="min-h-[calc(100vh-4.5rem)] bg-gray-50 dark:bg-sapDark flex items-center justify-center p-4">
  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100vh-4.5rem)] bg-gray-50 dark:bg-sapDark">
